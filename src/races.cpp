...
const Race DemiGiant("Demi-Giant", {8, -2, -2, -2, 4, -2},
        {"Barbarian", "Cleric"});
...
const Race Lunari("Lunari", {-2, 2, 2, 2, 0, 0},
        {"Sage", "Magic User", "Druid"});
const Race Orc("Orc", {4, -2, -2, 0, 0, -2}, {"Barbarian"});
const Race Solari("Solari", {2, 0, 2, 0, 0, 2},
        {"Fighter", "Paladin", "Cleric"});
const Race Swertling("Swertling", {0, -2, -2, 0, 0, -2},
        {"Barbarian", "Cleric"});
